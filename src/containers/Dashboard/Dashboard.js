      ...
      <Grid container alignItems="center" className={classes.header}>
        <Grid item className={classes.heroText}>
          <Typography variant="h4" gutterBottom>
            Deep dive into the feild of AI , ML and Data science
          </Typography>
          <Typography variant="subtitle1" gutterBottom>
            Learn How To Build Models & programs with industry-level expertise
          </Typography>
      ...
      <Box className={classes.intro}>
        ...
        >
          <Box mx={5} minWidth={315} alignSelf="center">
            ...
            <Box mt={3}>
              <Typography>
                Simply sign up as a verified user on Tech-labs to start to
        ...
        >
            ...
            <Box display="flex">
              ...
              <Box ml={1} display="flex" flexDirection="column">
                ...
                <Typography style={{ marginTop: 16 }}>
                  Tech-labs is collect on many resourses. People who study at
                  the Tech-labs can archive knowledge by join suitable topic.
                </Typography>
              </Box>
            </Box>
          </Box>
          ...
          <Box alignSelf="flex-start" maxWidth={500} m={5}>
            <Box display="flex">
              ...
              <Box ml={1} display="flex" flexDirection="column">
                <Typography variant="h4">
                  Tech-labs users easy to achieve the desired skills
                </Typography>
                <Typography style={{ marginTop: 16 }}>
                  Tech-labs system is meticulously built to enhance the
